...
namespace Pixelnest.BulletML
{
  ...
  public class BulletManagerScript : MonoBehaviour, BulletMLLib.IBulletManager
  {
    ...
    void Start()
    {
      ...
      // Check prefabs
      if (player == null && GetPlayerPosition == null) UnityEngine.Debug.LogError("Missing 'player' reference for BulletManagerScript!");
      if (bulletBank == null && OnBulletSpawned == null) UnityEngine.Debug.LogError("Missing 'bulletBank' for BulletManagerScript!");
    }
    ...
    public Vector2 PlayerPosition(BulletMLLib.Bullet sourceBullet)
    {
      if (GetPlayerPosition != null)
      {
        ...
        {
          UnityEngine.Debug.LogError("Unable to get the parent from " + sourceBullet);
        }
